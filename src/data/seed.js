...
const PROCEDURE_TYPES = [
  // Cardiaque
  { id: 'pt-cec', name: 'Circulation extra-corporelle', abbr: 'CEC', scope: 'both', serviceType: 'cardiaque' },
  { id: 'pt-cabg', name: 'Pontage aorto-coronarien', abbr: 'CABG', scope: 'both', serviceType: 'cardiaque' },
  { id: 'pt-rva', name: 'Remplacement valvulaire aortique', abbr: 'RVA', scope: 'both', serviceType: 'cardiaque' },
  { id: 'pt-rvm', name: 'Remplacement valvulaire mitral', abbr: 'RVM', scope: 'both', serviceType: 'cardiaque' },
  { id: 'pt-plastie', name: 'Plastie mitrale', abbr: 'Plastie M.', scope: 'both', serviceType: 'cardiaque' },
  { id: 'pt-aorte', name: 'Remplacement aorte ascendante', abbr: 'Aorte asc.', scope: 'both', serviceType: 'cardiaque' },
  { id: 'pt-civ', name: 'Fermeture CIV', abbr: 'CIV', scope: 'both', serviceType: 'cardiaque' },
  { id: 'pt-cia', name: 'Fermeture CIA', abbr: 'CIA', scope: 'both', serviceType: 'cardiaque' },
  { id: 'pt-ecmo', name: 'Pose ECMO', abbr: 'ECMO', scope: 'both', serviceType: 'cardiaque' },
  { id: 'pt-lvad', name: 'Pose LVAD / BiVAD', abbr: 'LVAD', scope: 'both', serviceType: 'cardiaque' },
  // Thoracique
  { id: 'pt-lob', name: 'Lobectomie', abbr: 'Lobectomie', scope: 'both', serviceType: 'thoracique' },
  { id: 'pt-seg', name: 'Segmentectomie', abbr: 'Segmentectomie', scope: 'both', serviceType: 'thoracique' },
  { id: 'pt-pneumo', name: 'Pneumonectomie', abbr: 'Pneumonectomie', scope: 'both', serviceType: 'thoracique' },
  { id: 'pt-resec', name: 'Résection atypique', abbr: 'Résection at.', scope: 'both', serviceType: 'thoracique' },
  { id: 'pt-pleur', name: 'Pleurectomie', abbr: 'Pleurectomie', scope: 'both', serviceType: 'thoracique' },
  { id: 'pt-decort', name: 'Décortication pleurale', abbr: 'Décortication', scope: 'both', serviceType: 'thoracique' },
  { id: 'pt-thym', name: 'Thymectomie', abbr: 'Thymectomie', scope: 'both', serviceType: 'thoracique' },
  { id: 'pt-oeso', name: 'Œsophagectomie', abbr: 'Œsophagectomie', scope: 'both', serviceType: 'thoracique' },
  { id: 'pt-vats', name: 'Chirurgie thoracoscopique vidéo-assistée', abbr: 'VATS', scope: 'both', serviceType: 'thoracique' },
  { id: 'pt-drain', name: 'Pose de drain thoracique', abbr: 'Drain', scope: 'both', serviceType: 'thoracique' },
  { id: 'pt-medias', name: 'Médiastinoscopie', abbr: 'Médiastinoscopie', scope: 'both', serviceType: 'thoracique' },
